...
export function Button(props: Props & JSXInternal.HTMLAttributes<HTMLButtonElement>) {
  ...
  return (
    <button
      type="button"
      className={cx(
        'rounded px-2 py-px active:pt-[2px] active:pb-0 disabled:opacity-60 disabled:!py-px',
        !primary && !secondary && 'bg-zinc-200 text-black active:bg-zinc-300',
        primary && 'bg-zinc-700 text-neutral-100 active:bg-zinc-800 disabled:!bg-zinc-700',
        secondary &&
